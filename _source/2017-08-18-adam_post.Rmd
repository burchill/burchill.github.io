...
![Front of the version with the profile of Robert Adam]({{ site.url }}/images/adam_ic/green_keys_face_front.png)
...
![Front of the version with the profile of Robert Adam, from a different angle]({{ site.url }}/images/adam_ic/green_keys_face_front2.png)
...
![Ganymede feeding Zeus in the form of an eagle.]({{ site.url }}/images/adam_ic/ganymede.png)
...
![A bust of Joan of Arc.]({{ site.url }}/images/adam_ic/joan.png)
